								...
								<div class="card-header">
                                    <div class="card-head-row">
                                        ...
                                        <div class="card-tools">
                                            <!-- <a href="{{url('backend/diskon/create')}}" class="btn btn-info btn-sm mr-2">
										...
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a href="{{('/backend/diskon/'.$row->id.'/edit')}}" class="btn btn-info btn-xs" title="Edit">
                                                                <span>
